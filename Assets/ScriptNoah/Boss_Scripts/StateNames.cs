public class StateNames
{
    ...
    {
        P1C_DASH,P1C_MIXDASH,P1C_SLAM,P1C_TELEPORTATION,P1D_BOOMERANG,P1D_SHOOT,P1D_SPIN, P1R_SPIRALE,
        P2C_DASH,P2C_MIXDASH,P2C_SLAM,P2C_TELEPORTATION,P2D_BOOMERANG,P2D_SHOOT,P2D_SPIN, P2R_SPIRALE
    };
    #region  p1
