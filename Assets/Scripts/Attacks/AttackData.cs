...
public class AttackData : MonoBehaviour
{
    ...
    DropdownList<string> attackName()
    {
        ...
        {"Dash on spear", Ccl_Attacks.DASHONSPEAR},
        {"Traveling Spear", Ccl_Attacks.TRAVELINGSPEAR},
        {"Left Spear Swing", Ccl_Attacks.SPEARSWINGL},
        {"Right Spear Swing", Ccl_Attacks.SPEARSWINGR},
        {"Danu Energy Ball", Danu_Attacks.PROJECTILE},
        {"Danu Dash 1", Danu_Attacks.DASH},
        {"Danu Dash 2", Danu_Attacks.DASH2},
        {"Danu Shockwave", Danu_Attacks.SHOCKWAVE},
        {"Danu Slam 1", Danu_Attacks.SLAM1},
        {"Danu Slam 2", Danu_Attacks.SLAM2},
        {"Danu Slam 3", Danu_Attacks.SLAM3},
        {"Danu Teleportation Explosion", Danu_Attacks.TP},
        };
    }
